...
WORKDIR /app
COPY --from=build /home/gradle/src/build/libs/code-coverage-tutorial-1.0-SNAPSHOT.jar /app
...
CMD ["java", "-jar","code-coverage-tutorial-1.0-SNAPSHOT.jar","server","hello-world.yml"]
